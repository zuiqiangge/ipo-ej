 ...
 *
 */
public class Xlcjgjgd extends CollectionNews {

	@Override
	public void collection() {
		String url = "http://roll.finance.sina.com.cn/finance/gjcj/gjjj/index.shtml";
		String nextUrl = null;
		int page = 2;
		try {
			do {
				...
				for (Element ele : eles) {
					...
					if(!getNewsService().urlExists(href)){
						...
						News news = getNewsBean(title, pubDate, SourceInfo.XLCJ_GJGD, "0", context, href);
						//添加到List
						newsList.add(news);
					}
				}
				...
				//做多取前100页
				if(page <= 100){
					nextUrl = "http://roll.finance.sina.com.cn/finance/gjcj/gjjj/index_"+page+".shtml";
					page++;
				}else{
					break;
				}
