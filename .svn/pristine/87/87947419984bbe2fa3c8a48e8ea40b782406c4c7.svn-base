 ...
 *
 */
public class Xlcjqtdq extends CollectionNews {

	@Override
	public void collection() {
		String url = "http://roll.finance.sina.com.cn/finance/gjcj/qtdq/index.shtml";
		String nextUrl = null;
		int page = 2;
		try {
			do {
				...
				for (Element ele : eles) {
					...
					if(!getNewsService().urlExists(href)){
						...
						News news = getNewsBean(title, pubDate, SourceInfo.XLCJ_QTDQ, "0", context, href);
				...
				//做多取前100页
				if(page <= 100){
					nextUrl = "http://roll.finance.sina.com.cn/finance/gjcj/qtdq/index_" + page + ".shtml";
					page++;
				}else{
					break;
				}
